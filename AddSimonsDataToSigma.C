...
void AddSimonsDataToSigma() {
  ...
  TFile *outfile =new TFile("/w/work3/home/chris/LatestAnalysisRuns/Data/DataJul18/HistoSelector/Pi0Analysis/TestSimons2.root","recreate");
...
cout << " SERIOUSLY WTF " << endl;
std::ofstream textfile;
textfile.open("MyResults.txt",std::ios_base::app);

for(Int_t ddd=0; ddd<VecAllSigma.size(); ddd++ ){
  textfile <<VecAllSigma[ddd]<<"  " << VecAllEg[ddd]<< "  "  << VecAllCosth[ddd]<< "   " <<VecFolder[ddd]<<endl;
