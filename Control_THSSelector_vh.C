...
// HSin("/w/work3/home/chris/LatestAnalysisRuns/Data/DataJul18/HaspectOutput/Pi0Analysis/AllFilesDev10MoellerPhiDaria/");
...
//  tree->Add(HSin()+"Physics_CBTaggTAPS_15757*");
