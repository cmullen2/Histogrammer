...
// Thu Feb  1 23:34:08 2018 by ROOT version 6.08/06
// from TTree HSParticles/A tree containing reconstructed particles
// found on file: /w/work1/home/chris/LatestAnalysisRuns/Data/DataJul17/HaspectOutput/TestMulti/Dev17.0Files20PhysicsAll.root
//////////////////////////////////////////////////////////

#ifndef CutsTHSSelector_vh_h
#define CutsTHSSelector_vh_h
...
class CutsTHSSelector_vh : public TSelector, public THSOutput {
public :
...
//   TTreeReaderValue<Double_t> Topo = {fReader, "Topo"};
   TTreeReaderValue<Double_t> TopoMine = {fReader, "TopoMine"};
...
//   TTreeReaderValue<TLorentzVector> Produc = {fReader, "Produc"};
   TTreeReaderValue<Double_t> UID = {fReader, "UID"};


   CutsTHSSelector_vh(TTree * /*tree*/ =0) { }
   virtual ~CutsTHSSelector_vh() {SafeDelete(fWeights); /*//SafeDelete(fp1);//If we add pointer ro classmust delete it*/  }
...
//Add THSHisto functions
   ...
   ClassDef(CutsTHSSelector_vh,0);

};

#endif

#ifdef CutsTHSSelector_vh_cxx
void CutsTHSSelector_vh::Init(TTree *tree)
{
...
Bool_t CutsTHSSelector_vh::Notify()
{
...
#endif // #ifdef CutsTHSSelector_vh_cxx
