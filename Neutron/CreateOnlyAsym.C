...
//  TFile *infile = TFile::Open("/w/work3/home/chris/LatestAnalysisRuns/Data/DataJul18/HistoSelector/Pi0Analysis/NPi0ResultCoplan3BG.root");
  TFile *infile = TFile::Open("/w/work3/home/chris/LatestAnalysisRuns/Data/DataJul18/HistoSelector/Pi0Analysis/NPi0ResultsStrictCuts.root");

//  TFile *outfile =new TFile("/w/work1/home/chris/HistoSelector/InvMassCutAsymsBinsProtonChannel.root","recreate");
//  TFile *outfile =new TFile("/w/work3/home/chris/LatestAnalysisRuns/Data/DataJul18/HistoSelector/Pi0Analysis/AsymsNPi0ResultCoplan3BG.root","recreate");
  TFile *outfile =new TFile("/w/work3/home/chris/LatestAnalysisRuns/Data/DataJul18/HistoSelector/Pi0Analysis/AsymsNPi0ResultsStrictCuts.root","recreate");
//  string dirs[3] = {"BG","Sig", "Cut1"};
  string dirs[3] = {"Random","TimeCoinc", "Cut1"};
//  string dirs[3] = {"ThreeBGs","Sig", "Cut1"};
//  string dirs[3] = {"Random","Sig", "Cut1"};
//  string dirs[4] = {"NPipPi0","PPi0Pim","Sig", "Cut1"};
//  string dirs[6] = {"BG","NPi0Pi0","NPipPi0","PPi0Pi0","Sig", "Cut1"};
