...
*/
      ...
      TString reduceNameStart = redName.ReplaceAll("TopoMine-0.50_GammaAveTagDiffTime-30.00_BeamEnergy"," ");
      TString reduceNameEnd = reduceNameStart.ReplaceAll("_DCorrect0.49_AnyErrs0.00_Coplanarity0.00_MissMass2075.00_ConeAngle0.25_InvMass140.00_Phi0.00_"," ");	
...
textfile.open("MyResultsUnBinnedNeutronSigmaMay29.txt",std::ios_base::app);
