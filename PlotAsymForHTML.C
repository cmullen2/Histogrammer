void PlotAsymForHTML() {
  ...
  ofstream outHtml;
  outHtml.open("/home/chris/public_html/Meetings/outhtmlComparisonFits/Proton/CoplanFitsAsyms/summary.html");
  ...
  TFile *infile = TFile::Open("/w/work3/home/chris/LatestAnalysisRuns/Data/DataJul18/HistoSelector/Pi0Analysis/CheckFits/AsymsPPi0ResultPoly2ndOrdMoreBinsFinalNewFitWithFluxCorrections.root");
...
//    outHtml << "<TABLE>" << endl;
    ...
    can->SaveAs("/home/chris/public_html/Meetings/outhtmlComparisonFits/Proton/CoplanFitsAsyms/"+imFileName);
    can->Clear();	
