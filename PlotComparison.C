...
void PlotComparison() {
  ...
  TFile *outfile =new TFile("/w/work3/home/chris/LatestAnalysisRuns/Data/DataJul18/HistoSelector/Pi0Analysis/ResultsPPi0UnBinnedVsSimonVsCoplanFits.root","recreate");
...
//Binned Spectator momentum will need 8 of these, means need to adjust other scripts, Need a spearate script to read in the 8 spectator ones and separate them. Then load in 8 here.
//50-100MeV
  vector<Double_t> VecAllChrisSigmaSpec2;
  vector<Double_t> VecAllChrisEgSpec2;
  vector<Double_t> VecAllChrisCosthSpec2;
  vector<TString> VecAllChrisTypeSpec2;
  vector<Double_t> VecAllChrisSigmaErrSpec2;
  vector<Double_t> VecAllChrisEgErrSpec2;
  vector<Double_t> VecAllChrisCosthErrSpec2;

//Binned Spectator momentum will need 8 of these, means need to adjust other scripts, Need a spearate script to read in the 8 spectator ones and separate them. Then load in 8 here.
//100-150MeV
  vector<Double_t> VecAllChrisSigmaSpec3;
  vector<Double_t> VecAllChrisEgSpec3;
  vector<Double_t> VecAllChrisCosthSpec3;
  vector<TString> VecAllChrisTypeSpec3;
  vector<Double_t> VecAllChrisSigmaErrSpec3;
  vector<Double_t> VecAllChrisEgErrSpec3;
  vector<Double_t> VecAllChrisCosthErrSpec3;

//Binned Spectator momentum will need 8 of these, means need to adjust other scripts, Need a spearate script to read in the 8 spectator ones and separate them. Then load in 8 here.
//150-200MeV
  vector<Double_t> VecAllChrisSigmaSpec4;
  vector<Double_t> VecAllChrisEgSpec4;
  vector<Double_t> VecAllChrisCosthSpec4;
  vector<TString> VecAllChrisTypeSpec4;
  vector<Double_t> VecAllChrisSigmaErrSpec4;
  vector<Double_t> VecAllChrisEgErrSpec4;
  vector<Double_t> VecAllChrisCosthErrSpec4;

//Binned Spectator momentum will need 8 of these, means need to adjust other scripts, Need a spearate script to read in the 8 spectator ones and separate them. Then load in 8 here.
//200-250MeV
  vector<Double_t> VecAllChrisSigmaSpec5;
  vector<Double_t> VecAllChrisEgSpec5;
  vector<Double_t> VecAllChrisCosthSpec5;
  vector<TString> VecAllChrisTypeSpec5;
  vector<Double_t> VecAllChrisSigmaErrSpec5;
  vector<Double_t> VecAllChrisEgErrSpec5;
  vector<Double_t> VecAllChrisCosthErrSpec5;

//Binned Spectator momentum will need 8 of these, means need to adjust other scripts, Need a spearate script to read in the 8 spectator ones and separate them. Then load in 8 here.
//250-300MeV
  vector<Double_t> VecAllChrisSigmaSpec6;
  vector<Double_t> VecAllChrisEgSpec6;
  vector<Double_t> VecAllChrisCosthSpec6;
  vector<TString> VecAllChrisTypeSpec6;
  vector<Double_t> VecAllChrisSigmaErrSpec6;
  vector<Double_t> VecAllChrisEgErrSpec6;
  vector<Double_t> VecAllChrisCosthErrSpec6;

//Binned Spectator momentum will need 8 of these, means need to adjust other scripts, Need a spearate script to read in the 8 spectator ones and separate them. Then load in 8 here.
//300-350MeV
  vector<Double_t> VecAllChrisSigmaSpec7;
  vector<Double_t> VecAllChrisEgSpec7;
  vector<Double_t> VecAllChrisCosthSpec7;
  vector<TString> VecAllChrisTypeSpec7;
  vector<Double_t> VecAllChrisSigmaErrSpec7;
  vector<Double_t> VecAllChrisEgErrSpec7;
  vector<Double_t> VecAllChrisCosthErrSpec7;

//Binned Spectator momentum will need 8 of these, means need to adjust other scripts, Need a spearate script to read in the 8 spectator ones and separate them. Then load in 8 here.
//350-400MeV
  vector<Double_t> VecAllChrisSigmaSpec8;
  vector<Double_t> VecAllChrisEgSpec8;
  vector<Double_t> VecAllChrisCosthSpec8;
  vector<TString> VecAllChrisTypeSpec8;
  vector<Double_t> VecAllChrisSigmaErrSpec8;
  vector<Double_t> VecAllChrisEgErrSpec8;
  vector<Double_t> VecAllChrisCosthErrSpec8;
