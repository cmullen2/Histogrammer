...
void GetCorrectionFromFile(vector<Double_t>  &VecSigma, vector<Double_t> &VecEg ,vector<Double_t> &VecCosth,vector<Double_t> &VecCorrFac , TString InFileName );
...
////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  TString InFilePSCF = "SAIDProtonCorrectionFactorUnBin.txt";
  GetCorrectionFromFile( VecAllChrisSigmaPSCF, VecAllChrisEgPSCF, VecAllChrisCosthPSCF, VecAllChrisCorrectionFactorPSCF,InFilePSCF );

//////////////////////////////////////////////////////////////////////////////////////////////////
  Double_t ArrCorrFactor[11];
  Double_t ArrEgPSCF[11];
  Double_t ArrEgPSCFErrs[11];
  Double_t ArrCorrFactorErrs[11];
///////////////////////////////////////////////////////////////////////////////////////////////////
  for(Int_t i=0;i<11;i++){//Number of eg bins//Deprecated*Number of folders(rand,sig,cut1) 41*3
	ArrCorrFactor[i]= VecAllChrisCorrectionFactorPSCF[5 +i*20];
	ArrEgPSCF[i] = VecAllChrisEgPSCF[5+i*20];

	ArrCorrFactorErrs[i]=0.00001;
	ArrEgPSCFErrs[i] = 10;
}   

    auto c3 = new TCanvas("c3","c3");
    //Declare Graphs
    TGraph* SigmaPlotPSCF=new TGraphErrors(11,ArrEgPSCF,ArrCorrFactor,ArrEgPSCFErrs,ArrCorrFactorErrs);
...
void GetCorrectionFromFile(vector<Double_t>  &VecSigma, vector<Double_t> &VecEg ,vector<Double_t> &VecCosth , vector<Double_t> &VecCorrFac, TString InFileName ){
  ...
  if (inputFileSpec.is_open()){
    while(getline(inputFileSpec, lineSpec) ){
      stringstream(lineSpec)>>Sigma >>Eg >> Costh >>CorrectionFactor;
